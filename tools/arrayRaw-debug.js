    ...
    ,
    {
      ...
      "habilidadesBasicas": [
        ...
        },
        {
          ...
          "bonus": ["Troca valores de um atributo por outro antes da campanha"]
        }
      ],
      "habilidadesAvancadas": []
    },
    {
      ...
      "habilidadesBasicas": [
        ...
        },
        {
          ...
          "bonus": ["+3 em ações de suporte/defesa para proteger aliados"]
        }
      ],
      "habilidadesAvancadas": []
    },
      ...
      "habilidadesBasicas": [
        {
          ...
          "bonus": ["Uma vez por "cena": ignorar penalidades mentais ativas"]
        },
        {
          ...
          "bonus": ["+1 dado extra em testes de ataque ou uso prático de armas físicas"]
        },
        {
          "nome": "Veterano",
          "descricao": "Anos de serviço ativo concedem ao Militar um olho clínico para a guerra.",
          "bonus": ["Bônus narrativo em identificar formações táticas, estimar números e prever estratégias"]
        }
      ],
      "habilidadesAvancadas": []
    }
    ...
    },
    {
      ...
      "habilidadesBasicas": [
        ...
        },
        {
          ...
          "bonus": ["Uma vez por sessão: movimento evasivo e reposicionamento seguro"]
        },
        {
      ...
      "habilidadesBasicas": [
        {
          ...
          "bonus": ["Bônus elevados em testes de conhecimento e memorização; reduz necessidade de rolagens"]
        },
        {
          "nome": "Didática",
          ...
          "bonus": ["Concede bônus temporários a aliados após explicação detalhada (próxima cena)"]
        },
        {
          ...
          "bonus": ["Redução de tempo para descobrir informações; bônus em investigações com recursos disponíveis"]
        }
      ],
      "habilidadesAvancadas": []
    },
      ...
      "habilidadesBasicas": [
        {
          ...
          "bonus": ["Uma vez por "cena": reação imediata para evitar desastre iminente"]
        },
        {
          "nome": "Casca Grossa",
          ...
          "bonus": ["Redução de efeitos negativos por condições ambientais e exaustão"]
        },
        {
          "nome": "Improvisador",
          ...
          "bonus": ["Criação improvisada de ferramentas, curativos e abrigos com recursos limitados"]
        }
      ],
      "habilidadesAvancadas": []
    }
        ...
        "habilidadesBasicas": [
          {
            ...
            "bonus": ["Uma vez por "cena": bônus extra massivo em testes de bravura, resistência moral ou liderança"]
          },
          {
            "nome": "Destemido",
            ...
            "bonus": ["Parcial imunidade/ignora penalidades leves de Medo, Pavor, Intimidação ou magias de controle mental"]
          },
          {
            ...
            "bonus": ["Uma vez por "campanha": ao sofrer ataque letal/critico, recupera quantidade significativa de HP"]
          }
        ],
        "habilidadesAvancadas": []
      },
        ...
        "habilidadesBasicas": [
          {
            ...
            "bonus": ["Aprende fórmulas/feitiços/idiomas em metade do tempo; +2 Aptidões gratuitas"]
          },
          {
            ...
            "bonus": ["Bônus substanciais em testes de INT relacionados a lógica, criptografia e engenharia"]
          },
          {
            ...
            "bonus": ["Uma vez por "cena": analisar cenário e coordenar reposicionamento/táticas dos aliados"]
          }
        ],
        "habilidadesAvancadas": []
      },
        ...
        "habilidadesBasicas": [
          {
            ...
            "bonus": ["Influenciar NPCs de alto escalão; obter favores, informações ou livre trânsito"]
          },
          {
            ...
            "bonus": ["Solicitar equipamentos, financiamento ou apoio temporário de guardas/especialistas"]
          },
          {
            ...
            "bonus": ["Bônus em técnicas de combate selecionadas e habilidades sociais/acadêmicas específicas"]
          }
        ],
        "habilidadesAvancadas": []
      },
        ...
        "habilidadesBasicas": [
          {
            ...
            "bonus": ["Bônus contínuo, permanente e cumulativo em testes de INT e uso de habilidades místicas"]
          },
          {
            "nome": "Energia Juvenil",
            ...
            "bonus": ["Uma vez por "cena": repetir qualquer teste físico falhado, mantendo o melhor resultado"]
          },
          {
            "nome": "Inspiração",
            ...
            "bonus": ["Aliados próximos recebem bônus temporários significativos em testes e rolagens"]
          }
        ],
        "habilidadesAvancadas": []
      },
        ...
        "habilidadesBasicas": [
          {
            ...
            "bonus": ["Bônus adicionais constantes e progressivos em testes de atributos principais e uso de Arts"]
          },
          {
            ...
            "bonus": ["Uma vez por "cena": prever ação/ataque do inimigo, permitindo esquiva ou contra-ataque com vantagem"]
          },
          {
            ...
            "bonus": ["Aliados sob sua liderança recebem bônus significativos em combate, resistência mental e testes sociais"]
          }
        ],
        "habilidadesAvancadas": []
      },
        ...
        "habilidadesBasicas": [
          {
            ...
            "bonus": ["Uma vez por sessão: aumentar temporariamente um atributo em +15"]
          },
          {
            ...
            "bonus": ["Uma vez por "cena": mitigar dano crítico/fatal e anular efeitos colaterais"]
          },
          {
            ...
            "bonus": ["Uma vez por sessão: detectar armadilhas, emboscadas, mentiras ou presenças invisíveis"]
          }
        ],
        "habilidadesAvancadas": []
      },
        ...
        "habilidadesBasicas": [
          {
            ...
            "bonus": ["Pode escolher e utilizar Aptidões/perícias dominadas em vidas anteriores"]
          },
          {
            ...
            "bonus": ["Bônus constantes em testes já dominados em vidas anteriores"]
          },
          {
            "nome": "Renascimento",
            ...
            "bonus": ["Uma vez por "campanha": reanimação/reencarnação com metade dos recursos físicos e energéticos"]
          }
        ],
        "habilidadesAvancadas": []
      }
