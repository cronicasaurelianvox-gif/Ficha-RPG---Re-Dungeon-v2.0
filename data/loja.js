...
const LOJA_ITENS = {
  ...
  armaduraCouroReorcado: {
    ...
    descricao: 'Couro tratado e reforçado com placas leves. Concede 2d8+3 de Defesa. Reduz +25 HP enquanto usa.',
  ...
  armaduraMalha: {
    ...
    dificuldade: 'Moderado (-9)',
    descricao: 'Malha metálica entrelaçada que protege o torso e braços. Concede 3d8+9 de Defesa. Reduz +50 HP enquanto usa.',
  ...
  armaduraEscamas: {
    ...
    descricao: 'Armadura composta por placas sobrepostas em formato de escamas. Concede 3d10+5 de Defesa. Reduz +75 HP enquanto usa.',
